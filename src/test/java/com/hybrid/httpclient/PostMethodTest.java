 ...
 * 
 * url param                               o      o       o       o       o
 * application/x-www-form-urlencoded       x      o       x       x       x
 * application/json                        x      o       o       x       o
 * 
 */


public class PostMethodTest {
	static Log log = LogFactory.getLog(PostMethodTest.class);
	...
	public static void main(String[] args) {
		...
		try {
			 ...
			 * HttpPost
			 */
			HttpPost post = new HttpPost(new URI("http://localhost:8080/HttpClient/post/json"));
